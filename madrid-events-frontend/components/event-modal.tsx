...
export default function EventModal({
  ...
  const renderMetroLines = () => {
    ...
    return renderInfoItem(
      RailSymbol,
      intl.formatMessage({ id: 'app.event.subway.lines' }),
      metroLines,
    );
  };
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`${colorPalette.cardBg} rounded-lg overflow-hidden shadow-xl max-h-[90vh] overflow-y-auto scrollbar-hide`}
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              {renderInfoItem(
                ...
                event.free && event.price === ''
                  ...
                  : event.price || intl.formatMessage({ id: 'app.event.free' }),
              )}
